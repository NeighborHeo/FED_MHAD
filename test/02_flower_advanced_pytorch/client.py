...
def client_dry_run(device: str = "cpu", experiment: Optional[Experiment] = None) -> None:
    ...
    client = CifarClient(trainset, testset, device, experiment= experiment)
    client.fit(
...
def main() -> None:
    ...
    if args.dry:
        client_dry_run(device, experiment)
    else:
