...
class PascalVocPartition:
    def __init__(self, args: argparse.Namespace):
        ...
        self.path = pathlib.Path.home().joinpath('.data', 'PASCAL_VOC_2012', 'N_clients_5_alpha_1000_noise_symmetric_0.1')
    ...
    def load_partition(self, i: int):
        ...
        if i == -1:
            ...
            for i in range(self.args.N_parties):
                ...
                party_label = np.load(self.path.joinpath(f'Party_{i}_y_data_noisy.npy'))
